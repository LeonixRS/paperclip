...
- readOnly (boolean, optional): inject a runtime OpenCode config that denies \`edit\` and \`bash\` so the agent can only read the workspace; takes precedence over dangerouslySkipPermissions. Defaults to false
